...
int main(int argc, char* argv[]){       
  try{
    ...
    ros::ServiceServer service_solve = n.advertiseService("Solve_Problem", &Application::SrvSolveProblem, &kauthApp);
    ...
    ros::ServiceServer service_query = n.advertiseService("Request_Query", &Application::SrvSolveQuery, &kauthApp);
    ros::ServiceServer service_save = n.advertiseService("Save_Data", &Application::SrvSaveData, &kauthApp);
    ros::ServiceServer service_load = n.advertiseService("Load_Data", &Application::SrvLoadData, &kauthApp);
