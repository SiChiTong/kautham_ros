...
int main(int argc, char* argv[]){       
  try{
    ...
    ros::ServiceServer service_foo2 = n.advertiseService("Viewer_Foo2", &Application::SrvFoo2, &kauthApp);
    ros::ServiceServer service_foo = n.advertiseService("Viewer_Foo", &Application::SrvFoo, &kauthApp);
